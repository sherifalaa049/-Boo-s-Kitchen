(() => {
  ...
  const menuItems = [
    { category: 'pizza', name: 'Ember Margherita', description: 'San Marzano tomato, fresh basil, mozzarella, ember-charred crust.', price: 18, img: 'img/menu/Cuisine Créative (1).jfif' },
    { category: 'pizza', name: 'Truffle Gold Pizza', description: 'Truffle cream, wild mushrooms, parmesan snow, black pepper sparkle.', price: 26, img: 'img/menu/Pizza Tartuffo.jfif' },
    { category: 'pizza', name: 'Spicy Gold Pepperoni', description: 'Pepperoni cups, roasted chilies, hot honey glaze, basil finish.', price: 24, img: 'img/menu/Pepperoni Vodka Skillet Pizza with Hot Honey.jfif' },

    { category: 'burgers', name: 'Smash Ember Burger', description: 'Double smash patties, caramelized onions, ember sauce, brioche.', price: 20, img: 'img/menu/10 Best Smash Burger Recipes That Will Transform Your Backyard BBQ Game.jfif' },
    { category: 'burgers', name: 'Truffle Royale Burger', description: 'Truffle mayo, roasted garlic, fontina, crisp greens, gold dust.', price: 28, img: 'img/menu/download.jfif' },
    { category: 'burgers', name: 'Garden Heat Burger', description: 'Charred peppers, jalapeño relish, avocado silk, citrus crunch.', price: 22, img: 'img/menu/download (1).jfif' },

    { category: 'pasta', name: 'Truffle Cream Linguine', description: 'Silky truffle cream, parmesan, herb aroma, slow simmer depth.', price: 25, img: 'img/menu/THE BEST Truffle Mushroom Tagliatelle Recipe.jfif' },
    { category: 'pasta', name: 'Smoky Pomodoro Rigatoni', description: 'Fire-roasted tomato, smoked basil, parmesan ribbons, al dente bite.', price: 21, img: 'img/menu/download (2).jfif' },
    { category: 'pasta', name: 'Lemon Herb Risotto', description: 'Zesty lemon, roasted garlic, fresh herbs, velvet finish.', price: 24, img: 'img/menu/Creamy Herb & Lemon Risotto_ Light, Creamy, and Delicious.jfif' },

    { category: 'desserts', name: 'Golden Velvet Cheesecake', description: 'Creamy cheesecake, caramelized crust, gold honey drizzle.', price: 14, img: 'img/menu/Yellow Velvet Oreo Cheesecake 🍰✨.jfif' },
    { category: 'desserts', name: 'Warm Ember Brownie', description: 'Molten center, cocoa richness, vanilla bean cloud.', price: 13, img: 'img/menu/Rich Fudgy Hazelnut Brownies - Easy Recipe by Sana.jfif' },
    { category: 'desserts', name: 'Citrus Gold Tart', description: 'Bright citrus curd, buttery crust, delicate sugar finish.', price: 15, img: 'img/menu/Classic Orange Tart – Bright & Zesty Citrus Dessert Recipe.jfif' },

    { category: 'drinks', name: 'Ember Iced Tea', description: 'Black tea, citrus, smoked hint, lightly sweetened premium chill.', price: 9, img: 'img/menu/Beat the Summer Heat with These Refreshing Iced Tea Recipes.jfif' },
    { category: 'drinks', name: 'Gold Citrus Spritz', description: 'Sparkling citrus, herbal aroma, elegant refresh with gold garnish.', price: 12, img: 'img/menu/Refreshing Aperol Spritz with Orange and Mint.jfif' },
    { category: 'drinks', name: 'Vanilla Noir Shake', description: 'Vanilla bean shake, cocoa swirl, creamy velvet sip.', price: 11, img: 'img/menu/Milkshake with Whipped Cream Recipe_Creamy, rich, and oh-so-delicious! This classic milkshake topped with fluffy whipped cream is the perfect treat for any time of day___Ingredients_For the Milkshake__2 cups vanilla.jfif' },
  ];
  ...
  // --------- Offers ---------
  const offers = [
    { tag: 'This Week', discount: '40%', title: 'Chef’s Gusteau Tasting', desc: 'A premium 4-course experience with a truffle surprise. Limited seats every night.', cta: 'Book Tasting' },
    ...
    { tag: 'New', discount: '25%', title: 'Family Feast Bundle', desc: 'Feeds 4–6: pizza, pasta, salads, dessert — assembled for celebrations.', cta: 'Reserve Bundle' },
  ];
